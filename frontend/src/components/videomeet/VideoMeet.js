...
export default function VideoMeetComponent() {
    ...
    const handleChatToggle = () => {
        ...
        // Code Editor को प्रभावित नहीं करता है
    };

    // ✅ NEW Code Editor Toggle Handler (स्वतंत्र)
...
const stopFileSharing = () => {
    ...
    return (
        <div className={styles.meetVideoContainer}>
            ...
            {/* ✅ Code Editor Area (जब isCodingMode ON हो तभी रेंडर होगा) */}
            {isCodingMode && (
                <CodeEditor
                    socketRef={socketRef}
                    roomId={window.location.href}
                    // CodeEditor को अन्य आवश्यक props यहाँ पास करें
                />
            )}
